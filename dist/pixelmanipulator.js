(function (g) {
    'use strict';
    var pix = function (require, exports, module) {
        /*function ret(v) {
            return (function() {
                return v;
            });
        ...
        PixelManipulator.prototype.zoom = function (e) {
            //console.log("zoom",e);
            if (typeof this.zoomelm.height === "undefined")
                return;
        ...
        PixelManipulator.prototype.__GetPixelId = function (d) {
        ...
        PixelManipulator.prototype.__ConfirmElm = function (getPixelId) {
            ...
            return function confirmElmGeneric(x, y, id, loop) {
                ...
                switch (typeof id) {
                    case "string":
                        id = p.getElementByName(id).number;
                        break;
    ...
    if (typeof g.require == "undefined" && typeof g.module == "undefined") {
        var exprt = pix(function () { return undefined; }, {}, undefined);
